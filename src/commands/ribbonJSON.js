...
function getContextualRibbonJSON(size) {
    return {
        "actions": [
          {
            "id": "idRibbonAction",
            ...
            "groups": [
              {
                ...
                "icon": [
                  {
                    "size": 16,
                    "sourceLocation": "https://localhost:5500/assets/icon-16.png"
                  },
                  {
                    "size": 32,
                    "sourceLocation": "https://localhost:5500/assets/icon-32.png"
                  },
                  {
                    "size": 80,
                    "sourceLocation": "https://localhost:5500/assets/icon-80.png"
                  }
                ],
                "controls": [
                  {
              ...
              },
              {
                ...
                "controls": [
                  ...
                  },
                  {
                    ...
                    "items": getMenuItems("itemCo", size)
                  },
                  {
                    "type": "Menu",
                    "id": "mnuTables",
                    ...
                    "items": getMenuItems("itemTbl", size)
                  },
                  {
                    "type": "Menu",
                    "id": "mnuReports",
                    ...
                    "items": getMenuItems("itemRpt", size)
                  }
                ]
              },
              {
